...
<head>
	...
	<link rel="icon" type="image/x-icon" href="${pageContext.request.contextPath}/admin/tcp/favicon.ico">
	<link rel="stylesheet" href="${pageContext.request.contextPath}/bdolx/css/bdolxTaxStyle.css">
			...
			<div class="sidebar-content">
				...
				<div class="side-content">
					<ul id="mainMenu" class="nav-main">
						<li><a id="defaultPage" class='menu nav-submenu'
							data-toggle='nav-submenu'
							target="general.do?menuid=60000002&bid=60000002" mid="60000002">
								<i class="si si-home"></i> <span class="sidebar-mini-hide h5">首页</span>
						</a></li>
					</ul>
				</div>
					<!-- END Side Content -->
...
<script src="${pageContext.request.contextPath}/bdolx/main/buMain.js"></script>
