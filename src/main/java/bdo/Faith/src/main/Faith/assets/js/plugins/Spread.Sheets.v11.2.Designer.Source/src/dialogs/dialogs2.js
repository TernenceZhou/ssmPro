(function () {
    ...
    var SortDialog = (function (_super) {
        ...
        SortDialog.prototype.sort = function () {
            ...
            if (activeSelection) {
                designer.actions.doAction('sortCustomRange', designer.wrapper.spread, { byRows: this._byRows, sortInfos: sortInfos });
            }
        };
        return SortDialog;
    })(designer.BaseDialog);
    ...
    var DataValidationDialog = (function (_super) {
        ...
        DataValidationDialog.prototype._loadValidatorSetting = function (dv) {
            ...
            this._value1.val(dv.value1(activeRow, activeColumn));
            this._value2.val(dv.value2(activeRow, activeColumn));
    ...
    var CalendarSparklineDialog = (function (_super) {
        ...
        CalendarSparklineDialog.prototype._setValueFromRangeSelect = function (selector, value) {
            var formula = value;
            if (value.indexOf('=') === 0) {
                formula = value.substr(1);
            }
