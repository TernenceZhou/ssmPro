...
//				GuidePage({region: '#guidePageTab', data: agrs.data});
				...
				case 'auditProgramPageTab':
					HbAuditProgramPagePlan({region: '#auditProgramPageTab', data: agrs.data});
					break;
...
//				PostilsPage({region: '#postilsPageTab'});
	...
	mount = () => {
		...
		listener();
		HbAuditProgramPagePlan({region: '#subjectPlanPageTab', data: agrs.data});
