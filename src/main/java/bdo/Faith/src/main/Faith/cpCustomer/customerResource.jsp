...
<%
UserSession uses = (UserSession) session.getAttribute("userSession");
String cusId = uses.getCustomerId();
	...
	<div class="block-content">
		<div class="row">
			...
			<div class="col-sm-5 col-lg-5">
				...
				<table id="folderTreeTable" class="table table-bordered table-striped table-hover">
				</table>
			</div>
...
<style type="text/css" id="-style">
	#myTree .node-{color:#555;border:none;}
</style>
...
<script src="${pageContext.request.contextPath}/cpCustomer/customerResource.js"></script>