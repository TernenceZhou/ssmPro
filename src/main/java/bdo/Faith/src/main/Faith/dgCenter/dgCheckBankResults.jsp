...
<script src="${pageContext.request.contextPath}/dgCenter/js/dg/dgCheckBankResults.js"></script>

<script>
	$(document).ready(() => {
		var nodeData = $.sessionStorage('checkBankResultsNode');
		if (nodeData) {
			DgCheckBankResultsPage({region: '#mainContent', data: nodeData});
		}
	});
</script>
</body>
