...
var SecondNotePage = (agrs) => {
	...
	_template = agrs.template || tplLoader('dgCenter/html/dg/secondNote.html');
	...
	function setCustomizeStyle(data) {
		...
		// 设置活动单元格
		if ($.sessionStorage('cellLinkFormula') != null) {
	...
	var ready = function() {
		designer = initDesignerSecondNote(_data);
