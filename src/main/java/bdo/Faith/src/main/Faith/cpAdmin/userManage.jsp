<%@ page language="java" contentType="text/html; charset=utf-8"
		...
		<div class="block block-bordered">
			<div class="block-header bg-primary">
				<ul class="block-options">
					...
					<li>
						<button id="btn_synchro" type="button">
							<i class="fa fa-refresh" style="color: white;" title="指定同步"></i>
						</button>
					</li>
					<li>
	...
	<script src="${pageContext.request.contextPath}/cpAdmin/userManage.js"></script>
