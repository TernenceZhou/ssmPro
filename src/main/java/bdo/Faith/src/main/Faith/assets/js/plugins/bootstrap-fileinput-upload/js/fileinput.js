...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tModal = '<div class="modal-dialog modal-lg{rtl}" role="document" style="height: 80%;">\n' +
                '  <div class="modal-content" style="height: 98%;margin-top: 6%;">\n' +
            ...
            vDefaultDim = {width: "100%", height: "100%"};
            self.defaults = {
                layoutTemplates: {
                    main1: tMain1,
                    main2: tMain2,
        ...
        _uploadBatch: function () {
            ...
            fnSuccess = function (data, textStatus, jqXHR) {
                ...
                var outData = self._getOutData(jqXHR, data), $thumbs = self._getThumbs(':not(.file-preview-error)'),
                    key = 0, op = self.ajaxOperations.uploadBatch,
    ...
    $.fn.fileinput.defaults = {
        ...
        allowedFileExtensions: null,//['xls', 'xlsx', 'xltx', 'xlsm', 'xltm', 'xlsb', 'xlam', 'jpg', 'png', 'doc', 'docx', 'zip', 'rar', 'pdf'],
