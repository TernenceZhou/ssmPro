					...
					<div class="form-group has-info">
						<div class="col-sm-2">
							<div class="form-material">
								<input class="form-control" type="text" id="search_providerName">
								<label for="search_providerName">提供人</label>
							</div>
						</div>
					</div>
					<div class="form-group has-info">
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form class="form-horizontal" id="sub_form"></form>
				</div>
			</div>
		</div>
	</div>
	<script src="${pageContext.request.contextPath}/cpShare/businessChance.js"></script>