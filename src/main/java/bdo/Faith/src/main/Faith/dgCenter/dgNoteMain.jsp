...
<script src="${pageContext.request.contextPath}/dgCenter/js/dg/postil2.js"></script>
<script src="${pageContext.request.contextPath}/dgCenter/js/dg/designer.js"></script>
<script src="${pageContext.request.contextPath}/dgCenter/js/dg/noteInfo.js"></script>
...
<script>
	$(document).ready(() => {
		...
		if (nodeData) {
			...
			NoteInfoPage({region: '#mainContent1', data: nodeData});
		}
	});
