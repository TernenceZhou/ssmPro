...
(function () {
    ...
    function updateLayout() {
        ...
        var spread = spread_ = designer.wrapper.spread;
    ...
    $(document).ready(function () {
        designer.loader.loadContent($('html'));
    ...
    designer.loader.ready(function () {
        ...
        updateLayout();
		designer.wrapper.spread.bind(GC.Spread.Sheets.Events.CellChanged, function (e, info) {
		    /*console.log(e);
			console.log(info);
			console.log(JSON.stringify(info));*/
			console.log(JSON.stringify(info.sheet.getCell(info.row, info.col)));
		});
    });
