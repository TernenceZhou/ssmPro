	...
	<div class="content">
		...
		<div class="block block-bordered">
			<div class="block-header  bg-primary">
				...
				<h3 class="block-title">业务登记单一览</h3>
			</div>
	...
	<div class="modal fade" id="eva_modal" tabindex="-1" role="dialog"
		aria-hidden="true" data-backdrop="static" data-keyboard="false">
			...
			<div class="modal-content">
				<div class="block block-themed block-transparent remove-margin-b">
					<div class="block-header bg-info">
						<ul class="block-options">
							<li>
								<button name="eva_close" type="button">
									<i class="si si-close"></i>
								</button>
							</li>
						</ul>
						<h3 class="block-title">合作评价</h3>
					</div>
				</div>
				<div class="modal-body" style="height: auto; overflow: visible;">
					<form class="form-horizontal" id="eva_form"></form>
				</div>
			</div>
		</div>
	</div>
	...
	<script src="${pageContext.request.contextPath}/cpShare/businessOffer.js"></script>