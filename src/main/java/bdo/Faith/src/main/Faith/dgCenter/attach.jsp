...
<script>
	$(document).ready(() => {
		...
		var filetType = getQueryString('filetType');
		if(filetType == 2){
			var $div = $('<iframe src="dgCenter/DgMain.previewSamplingFile.json?param1=' + autoId + '&param2=' + customerId + '&param3=' + projectId + '" allowfullscreen="true"  width="100%" height="99%" style="border: none;" onload="resize(this)"></iframe>');
			$('#mainContent').append($div);
		}else{
			var $div = $('<iframe src="dgCenter/DgMain.onlineAttachPreview.json?param1=' + autoId + '&param2=' + customerId + '&param3=' + projectId + '" allowfullscreen="true"  width="100%" height="99%" style="border: none;" onload="resize(this)"></iframe>');
			$('#mainContent').append($div);
		}
	});
	function resize(obj){
