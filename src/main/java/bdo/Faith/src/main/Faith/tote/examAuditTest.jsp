						...
						<div class="block-search">
							<div class="row">
								...
								<div class="form-group has-info">
									<div class="col-sm-2">
										<div class="form-material">
											<select class="js-select2 form-control" id="exam_status"
													style="width: 100%;">
												<option></option>
											</select> <label for="exam_status">考试状态</label>
										</div>
									</div>
								</div>
								<div class="form-group has-info">
									<div class="col-sm-2">
										<div class="form-material">
											<select class="js-select2 form-control" id="audit_status"
													style="width: 100%;">
												<option></option>
											</select> <label for="audit_status">审核状态</label>
										</div>
									</div>
								</div>
							</div>
...
<script src="${pageContext.request.contextPath}/tote/examAuditTest.js"></script>