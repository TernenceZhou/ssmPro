(function () {
    ...
    cn_res.contextMenu = {
        ...
        rightTag: "右标签...",
        noteFeature: "附注取值...",
        cashFlowFeature: "数据取值...",
        customClear: "清除公式以外内容...",
        /* ZQF END*/
        rowHeight: "行高...",
        columnWidth: "列宽...",
        hide: "隐藏",
    ...
    cn_res.ribbon = {
        ...
        custom: {
            custom: "立信",
            auditidentifier: "审计标识符",
            identifier_1: "竖加正确",
            identifier_2: "横加正确",
            identifier_3: "已发询证函/已收回询证函",
            identifier_4: "期初余额与上年审定数一致",
            identifier_5: "与试算平衡表一致",
            identifier_6: "与资产负债一致",
            identifier_7: "与利润表一致",
            identifier_8: "问题事后得到解决",
            identifier_9: "根据明细分类帐",
            identifier_10: "根据总分类帐",
            identifier_11: "追查至...原始凭证",
            identifier_12: "对损益有影响的调整",
            identifier_13: "对损益无影响的调整",
            identifier_14: "不适用",
            toolsdefined: "工具",
            formatPainter: "格式刷",
            userdefined: "自定义",
