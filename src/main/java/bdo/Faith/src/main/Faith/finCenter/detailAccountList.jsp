...
<div class="content">
	<div class="block">
		<ul class="nav nav-tabs" data-toggle="tabs" id="tab_detailaccount">
			<li class="active"><a href="#tab_tab_detailaccountser">明细账</a></li>
			<li class="pull-right">
				...
				<div class="content">
										...
										<div class="col-sm-2">
											<div class="form-material">
												<input class="form-control" type="text"
													id="detail_subjectid" autocomplete="off"> <label
									...
									<div class="form-group has-info">
										<div class="col-sm-2">
											<div class="form-material">
												...
												</select> <label for="detail_vouchartype">凭证类型</label>
											</div>
										</div>
									</div>
								</div>
					...
					<div class="block block-bordered" id="subjectlist_block">
						<div class="block-header  bg-primary">
							<ul class="block-options">
								<li>
									<button id="detailaccount_export" type="button"
										style="display: none;">
								...
								<li>
									<button id="detailaccount_export_dg" type="button"
										style="display: none;">
										<i class="si si-cloud-download" style="color: white;"
											title="导出到底稿附件"></i>
									</button>
...
<script
	src="${pageContext.request.contextPath}/finCenter/detailAccountList.js"></script>
<script
