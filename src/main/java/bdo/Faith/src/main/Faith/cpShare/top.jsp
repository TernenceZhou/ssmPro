...
<div class="home block-content" id="homePage">
	<div class="row">
		<div class="pull-right push-15-r">数据时间：<span id="currentTime"></span><a class="push-15-l" id="refreshData"><i class="fa fa-refresh" title="刷新"></i></a></div>
	</div>
	<div class="row">
		<div class="col-lg-3 col-sm-3 col-xs-3">
			<a class="block block-link-hover3 tiles" href="javascript:void(0)" data-toggle="tooltip" data-original-title="在审计平台中导入过财务数据的客户数量" title="在审计平台中导入过财务数据的客户数量" data-title="在审计平台中导入过财务数据的客户数量" >
		...
		<div class="col-lg-3 col-sm-3 col-xs-3">
			<a class="block block-link-hover3 tiles" href="javascript:void(0)" data-original-title="在审计平台中创建过底稿中心的项目数" title="在审计平台中创建过底稿中心的项目数" data-title="在审计平台中创建过底稿中心的项目数">
				<div class="block-header">
					<ul class="block-options">
						<li>
							<i class="si si-info"></i>
		...
		<div class="col-lg-3 col-sm-3 col-xs-3">
		<a class="block block-link-hover3 tiles" href="javascript:void(0)" data-toggle="tooltip" data-original-title="在执行中的个数/已完成的项目数" title="在执行中的个数/已完成的项目数" data-title="在执行中的个数/已完成的项目数">
			<div class="block-header">
				<ul class="block-options">
					<li>
						<i class="si si-info"></i>
		...
		<div class="col-lg-3 col-sm-3 col-xs-3">
			<a class="block block-link-hover3 tiles" href="javascript:void(0)" data-toggle="tooltip" data-original-title="未完成的批注/总的批注" title="未完成的批注/总的批注" data-title="未完成的批注/总的批注">
				<div class="block-header">
					<ul class="block-options">
						<li>
							<i class="si si-info"  data-toggle="tooltip" data-original-title="Edit Client"></i>
						</li>
					</ul>
			...
			<div class="block home-block-rounded">
				<div class="block-header">
					...
					<div class="row">
						...
						<div class="col-lg-3 col-sm-3 col-xs-3">
							<div class="form-material">
								<button id = "homeCustomerFinTableSearch" class = "btn btn-primary" style="width: 100px">查询</button>
								<button id = "homeCustomerFinTableReset" class = "btn btn-primary" style="width: 100px">重置</button>
							</div>
						</div>
					</div>
				</div>
				<div class="block-content pull-t" id="homeCustomerFinTableWrap">
					<table class="table table-borderless text-center remove-margin-b" id="homeCustomerFinTable">
					</table>
				</div>
			</div>
		</div>
			...
			<div class="block home-block-rounded">
				<div class="block-header">
					...
					<div class="row">
						...
						<div class="col-lg-3 col-sm-3 col-xs-3">
							<div class="form-material">
								<button id = "homeProjectTableSearch" class = "btn btn-primary" style="width: 100px">查询</button>
								<button id = "homeProjectTableReset" class = "btn btn-primary" style="width: 100px">重置</button>
							</div>
						</div>
					</div>
				</div>
				<div class="block-content pull-t" id="homeProjectTableWrap">
					<table class="table table-borderless text-center remove-margin-b" id="homeProjectTable">
					</table>
				</div>
			</div>
		</div>
			...
			<div class="block home-block-rounded">
				<div class="block-header">
					...
					<div class="row">
						...
						<div class="col-lg-3 col-sm-3 col-xs-3">
							<div class="form-material">
								<input class="form-control" type="text" id="home_postil_projectName">
							</div>
						</div>
						<div class="col-lg-3 col-sm-3 col-xs-3">
							<div class="form-material">
								<button id = "homePostilTableSearch" class = "btn btn-primary" style="width: 100px">查询</button>
								<button id = "homePostilTableReset" class = "btn btn-primary" style="width: 100px">重置</button>
							</div>
						</div>
					</div>
				</div>
				<div class="block-content pull-t" id="homePostilTableWrap">
					<table class="table table-borderless text-center remove-margin-b" id="homePostilTable">
					</table>
				</div>
			</div>
		</div>
		...
		<div class="col-lg-8">
			<div class="block home-block-rounded">
				...
				<div class="block-content">
					<div class="" id="chart4" data-height="250" style="height: 300px;width: 100%;max-width: 100%;"></div>
				</div>
			</div>
		</div>
		<div class="col-lg-4">
			<div class="block home-block-rounded">
				<div class="block-header">
					<h3 class="block-title  home-block-title2">最新动态</h3>
				</div>
				<div id="top_certificate" class="block-content">
