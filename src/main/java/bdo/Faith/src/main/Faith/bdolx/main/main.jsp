...
<div id="page-container" class="sidebar-l sidebar-o side-scroll header-navbar-fixed sidebar-mini">
					...
					<ul id="mainMenu" class="nav-main">
						<li>
							<a id="defaultPage" class='menu nav-submenu' data-toggle='nav-submenu'
							   target="./general.do?menuid=40000077&bid=40000077" 
							   mid="40000077">
	...
	<header id="header-navbar" class="content-mini content-mini-full" style="float:left;">
				...
				<div class="btn-group">
					<button class="btn btn-default btn-image dropdown-toggle" data-toggle="dropdown" type="button">
						<img src="./assets/img/avatars/avatar10.jpg" alt="Avatar"
							 id="userPhoto2"
							 onerror="this.src='./assets/img/avatars/avatar10.jpg';this.onerror=null">
		...
		<ul class="nav-header pull-left">
			...
			<li>
                <div class="font-w300" style="margin-top:-6px;margin-left:-10px;color:green">
                    <div>&nbsp;</div>
                    <button id="mergeScope" type="button" display="none" style="border:none;font-size:8px">合并范围内</button>
                </div>
            </li>
		</ul>
						...
						<div class="row text-center">
							...
							<div class="col-xs-4">
								<a class="block bdo-store-block" href="javascript:void(0)" id="main_faith_te">
									<div class="block-content bdo-store-block-content text-info  bg-gray-light" style="min-height:120px">
										<i class="fa fa-file-excel-o fa-2x bdo-store-block-icon"></i>
										<div class="font-w600 push-15-t push-15" style="width: 85px;">底稿模板</div>
									</div>
								</a>
							</div>
							<div class="col-xs-4">
								<a class="block bdo-store-block" href="javascript:void(0)" id="main_faith_benford_analysis">
									<div class="block-content bdo-store-block-content text-info  bg-gray-light" style="min-height:120px">
										<i class="fa fa-bar-chart fa-2x bdo-store-block-icon"></i>
										<div class="font-w600 push-15-t push-15" style="width: 85px;">自定义本福特分析</div>
									</div>
								</a>
							</div>
							<div class="col-xs-4">
								<a class="block bdo-store-block" href="javascript:void(0)" id="main_faith_cloud_account_checking">
									<div class="block-content bdo-store-block-content text-info  bg-gray-light" style="min-height:120px">
										<i class="fa fa-cloud fa-2x bdo-store-block-icon"></i>
										<div class="font-w600 push-15-t push-15" style="width: 85px;">智能对账云平台</div>
									</div>
								</a>
							</div>
							<div class="col-xs-4">
								<a class="block bdo-store-block" href="javascript:void(0)" id="general_table_parsing_platform">
									<div class="block-content bdo-store-block-content text-info  bg-gray-light" style="min-height:120px">
										<i class="fa fa-table fa-2x bdo-store-block-icon"></i>
										<div class="font-w600 push-15-t push-15" style="width: 85px;">SACP智阅</div>
									</div>
								</a>
							</div>
						</div>
	...
	<!-- 合并项目列表  -->
	<div class="modal fade" id="mergeProjectModal" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static" data-keyboard="false">
	        ...
	        <div class="modal-content">
	            <div class="block block-themed block-transparent remove-margin-b">
	                <div class="block-header bg-info">
	                    ...
	                    <h3 class="block-title">合并项目</h3>
	                </div>
	            </div>
	            <div class="modal-body" style="min-height: 300px; max-height: 500px">
	                <table id="modal_merge_project_table" class="table table-bordered table-striped table-hover"></table>
	            </div>
