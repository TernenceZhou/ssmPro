...
var PreviewAttach = (agrs) => {
	...
	_template = agrs.template || tplLoader('dgCenter/html/dg/previewAttach.html');
	...
	getExcelData = (param) => {
		spread = designer.Spread;
		$.ajax({
			url: 'dgCenter/DgMain.getAttach.json',
			type: 'POST',
			data: param,
			dataType: 'json',
			success(data) {
